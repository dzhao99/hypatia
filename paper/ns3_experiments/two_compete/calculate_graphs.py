...
src = 1206
dst = 1215
S = 200  # total simulation time in seconds
fstate_path = (
    "../../satellite_networks_state/gen_data_lasthop_deflection/"
    "kuiper_630_isls_plus_grid_ground_stations_top_100_algorithm_free_gs_one_sat_"
    "uplink_downlink_only_over_isls_lasthop_splitting/dynamic_state_100ms_for_200s"
)
